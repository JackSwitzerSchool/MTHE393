###########################################################################
## Makefile generated for component 'lab1_group2'. 
## 
## Makefile     : lab1_group2.mk
## Generated on : Tue Jan 14 10:05:50 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\lab1_group2.rt-win64
...
COMPILER_COMMAND_FILE     = lab1_group2_comp.rsp
CMD_FILE                  = lab1_group2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\lab1_group2.rt-win64
...
DEFINES_STANDARD = -DMODEL=lab1_group2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\lab1_group2_quarc_win64\lab1_group2.c $(START_DIR)\lab1_group2_quarc_win64\lab1_group2_data.c $(START_DIR)\lab1_group2_quarc_win64\lab1_group2_main.c $(START_DIR)\lab1_group2_quarc_win64\rtGetInf.c $(START_DIR)\lab1_group2_quarc_win64\rtGetNaN.c $(START_DIR)\lab1_group2_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = lab1_group2.obj lab1_group2_data.obj lab1_group2_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\lab1_group2_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\lab1_group2_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
lab1_group2.obj : "$(START_DIR)\lab1_group2_quarc_win64\lab1_group2.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\lab1_group2_quarc_win64\lab1_group2.c"


lab1_group2_data.obj : "$(START_DIR)\lab1_group2_quarc_win64\lab1_group2_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\lab1_group2_quarc_win64\lab1_group2_data.c"


lab1_group2_main.obj : "$(START_DIR)\lab1_group2_quarc_win64\lab1_group2_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\lab1_group2_quarc_win64\lab1_group2_main.c"


rtGetInf.obj : "$(START_DIR)\lab1_group2_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\lab1_group2_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\lab1_group2_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\lab1_group2_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\lab1_group2_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\lab1_group2_quarc_win64\rt_nonfinite.c"
