 ...
 *
 * Date:           Tue Jan 14 10:05:46 2025
 * Model version:  13.0
 * Matlab version: 9.7 (R2022a) 13-Nov-2021
 ****************************************************************************/
...
typedef RT_MODEL_lab1_group2_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * lab1_group2(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(lab1_group2_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://lab1_group2:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: lab1_group2 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
